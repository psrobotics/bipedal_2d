function [] = rbt_anime(x_arr, f_arr, fp_arr, ref_traj_v, T, N,...
...
for k = s_s:skip_k:len-s_end
    ...
    % axis range
    axis([x_t(4)-0.9, x_t(4)+0.9, -0.6, 0.6, 0.0, 1.2]);
    ...
    plot_cube(r_mat,...
              ...
              x_t(4:6)+r_mat*[0;0;0], black, 3);

    % leg 
    plot3(p_leg_arr_r_1(1,:), p_leg_arr_r_1(2,:), p_leg_arr_r_1(3,:),'color', blue,'linewidth',3);
    plot3(p_leg_arr_r_2(1,:), p_leg_arr_r_2(2,:), p_leg_arr_r_2(3,:),'color', orange,'linewidth',3);
    plot3(p_leg_arr_l_1(1,:), p_leg_arr_l_1(2,:), p_leg_arr_l_1(3,:),'color', darkGreen,'linewidth',3);
    plot3(p_leg_arr_l_2(1,:), p_leg_arr_l_2(2,:), p_leg_arr_l_2(3,:),'color', yellow,'linewidth',3);
    ...
    if k<len-fps_traj_len-1
        % fpos 1
         ...
         plot3(ref_traj_v.x_ref_f(4,k),...
               ...
               'o','linewidth',1.5,'color',grey,'markersize',6);
